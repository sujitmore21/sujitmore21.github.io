        ...
        <div class="lg:col-span-7 space-y-6 text-center lg:text-left">
          ...
          <div class="hero-stats grid grid-cols-2 sm:grid-cols-4 gap-4 pt-8 border-t border-slate-800/80">
            ...
            <div class="p-4 rounded-2xl glass-card text-center transition-all duration-300 hover:scale-105 hover:shadow-glow-purple hover:border-purple-400/40">
              <div class="stat-number text-2xl sm:text-3xl font-extrabold text-purple-400 font-mono" data-count="10" data-suffix="+">10+</div>
              <div class="text-xs text-slate-400 font-medium mt-1">Featured Apps</div>
            </div>
            <div class="p-4 rounded-2xl glass-card text-center transition-all duration-300 hover:scale-105 hover:shadow-glow-emerald hover:border-emerald-400/40">
              <div class="stat-number text-2xl sm:text-3xl font-extrabold text-emerald-400 font-mono" data-count="500" data-suffix="k+">500k+</div>
          ...
          <!-- Trusted Clients & Enterprise Brands Showcase -->
          <div class="pt-6 border-t border-slate-800/80">
            <p class="text-xs uppercase tracking-widest font-mono text-slate-400 font-semibold mb-3 text-center lg:text-left">
              <i class="fa-solid fa-award text-cyan-400 mr-1.5"></i> Trusted by Enterprise Leaders & Global Brands
            </p>
            <div class="flex flex-wrap items-center justify-center lg:justify-start gap-2 sm:gap-2.5">
              ...
              <span class="px-3 py-1.5 rounded-xl bg-slate-900/90 border border-slate-800 text-xs font-semibold text-slate-300 flex items-center gap-1.5 transition-all duration-300 hover:scale-105 hover:border-purple-400/50 hover:text-purple-300">
                <i class="fa-solid fa-wallet text-purple-400"></i> Fibitpro
              </span>
              <span class="px-3 py-1.5 rounded-xl bg-slate-900/90 border border-slate-800 text-xs font-semibold text-slate-300 flex items-center gap-1.5 transition-all duration-300 hover:scale-105 hover:border-pink-400/50 hover:text-pink-300">
                <i class="fa-solid fa-leaf text-pink-400"></i> One Green Planet
              </span>
            </div>
          </div>
